(function () {
	...
	function generateRSASSA_PKCS1_V1_5() {
	...
	//*********************************************************************************
	function createPKCS10Internal(keyPair,db,csrStruct)
	{
		//region Initial variables
		let sequence = Promise.resolve();
		...
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.4",
			value: new PrintableString({ value: csrStruct.SN })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.42",
			value: new PrintableString({ value: csrStruct.GN })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.11",
			value: new PrintableString({ value: csrStruct.OU })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.10",
			value: new PrintableString({ value: csrStruct.O })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.6",
			value: new PrintableString({ value: csrStruct.C })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.7",
			value: new Utf8String({ value: csrStruct.L })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.8",
			value: new Utf8String({ value: csrStruct.S })
		}));
		pkcs10.subject.typesAndValues.push(new AttributeTypeAndValue({
			type: "2.5.4.3",
			value: new Utf8String({ value: csrStruct.CN })
		}));
		...
		sequence = sequence.then(() =>
			{
				return generateRSASSA_PKCS1_V1_5();
			}
		);
		//endregion
	...
	//*********************************************************************************
	function createPKCS10(keyPair,db,csrStruct)
	{
		return Promise.resolve().then(() => createPKCS10Internal(keyPair,db,csrStruct)).then(() =>
		{
			var strPem = formatPEM(toBase64(arrayBufferToString(pkcs10Buffer)));
	...
	function verifyCertificate(strCert,strPub)
	{
		...
		.then(function(publicKey){
		    window.crypto.subtle.verify(
			    ...
			    publicKey, 
			    new Uint8Array(certificate.signatureValue), 
	...
	function parsePKCS10(strCSR)
	{
		...
		const stringPEM = strCSR.replace(/(-----(BEGIN|END) CERTIFICATE REQUEST-----|\n)/g, "").replace(/\r?\n|\r/g,'');
	...
	//*********************************************************************************
	function verifyPKCS10(strCSR)
	{
		return Promise.resolve().then(() =>
		{
			pkcs10Buffer = stringToArrayBuffer(fromBase64(strCSR
