(function () {
	...
	//**************************************************************************************
	const isGeneratorFunction$1 = generator =>
	{
		if(typeof generator === "undefined")
			return false;
		...
		return isGenerator$1(generator);
	};
	//**************************************************************************************
	//endregion
	//**************************************************************************************
	 ...
	 * @returns {Promise}
	 */
	function generatorsDriver$1(generatorInstance)
	{
		//region Check that we do have instance of "Generator" as input
		if(!isGenerator$1(generatorInstance))
		{
			if(isGeneratorFunction$1(generatorInstance))
		...
		return new Promise((resolve, reject) =>
		{
			...
			const callback = result =>
			{
				...
				switch(true)
				{
					...
					case isGeneratorFunction$1(generatorResult.value):
					case isGenerator$1(generatorResult.value):
						return ((generatorResult.done) ? generatorsDriver$1(generatorResult.value).then(driverResult =>
						{
							resolve(driverResult);
						}, onReject) : generatorsDriver$1(generatorResult.value).then(callback, onReject));
	...
	class CertificateChainValidationEngine
	{
		...
		sort()
		{
			...
			return generatorsDriver$1(function *generatorFunction()
			{
